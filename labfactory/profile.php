  ...
  editingTd = null;
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					if ($_SESSION['id_role_of_user'] == 1 ){
						echo "<li><a href=\"graficadmin/index.php\">Админисраторская панель</a></li>";
					}
					else{
	...
	<div class="container">
		<div class="row" >
			...
			<img src="<?php echo $user_data['foto'];?>" height="100"><br>
			<button type=button class="btn btn-xs btn-success">Сменить фото</button>
			</form>
			</div>
			<div class="col-sm-4">
				<div style="font-size: 250%;">
						<?php echo $user_data['surname_of_user'];
								echo " ";
							  echo $user_data['name_of_user'];?>
				</div>
				<br>
			...
			<div class="col-sm-6">
				<form method="POST">
					...
					<input type="text" name="phone" size="30%" autocomplete="off" placeholder="<?php echo $user_data['mobile_phone'];?>">     <button name="updateMobilePhone" type=\"submit\"  type=button class="btn btn-md btn-success">Редактировать</button>
				</form>
				<hr>
...
switch ($_SESSION['id_role_of_user']){
...
echo "
	<div class=\"container\" >
						<div class=\"row\" >
							<div class=\"col-sm-2\">
							<button style=\" width: 150px;\" class=\"btn btn-primary btn-sm\" id=\"userlist\" type=\"submit\">Список пользователей</button>
							<br>
							<br>
							<button class=\"btn btn-primary btn-sm\" style=\" width: 150px;\" id=\"room\" type=\"submit\">Оборудование</button>
							<br>
							<br>
							<button class=\"btn btn-primary btn-sm\" style=\" width: 150px;\" id=\"brend\" type=\"submit\">Свойство</button>
							<br>
							<br>
							<button class=\"btn btn-primary btn-sm\" style=\" width: 150px;\" id=\"\" type=\"submit\">Список изменений</button>
							<br>
							<br>
							<button class=\"btn btn-primary btn-sm\" style=\" width: 150px;\" id=\"\" type=\"submit\">Группа объектов</button>
							<br>
							<br>
							<button class=\"btn btn-primary btn-sm\" style=\" width: 150px;\" id=\"feedback\" type=\"submit\">Просмотр отзывов</button>
							</div>
							<div class=\"col-sm-10\">
								<div id=\"content\">
